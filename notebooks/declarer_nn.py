...
model_path = './declarer_model2/declarer'
...
X_train = np.load('./declarer_bin/X_train.npy')
Y_train = np.load('./declarer_bin/Y_train.npy')

X_val = np.load('./declarer_bin/X_val.npy')
Y_val = np.load('./declarer_bin/Y_val.npy')
